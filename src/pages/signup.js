...
import { useRegisterMutation } from "../src/api/react-user-query";
            ...
            <div className='w-50 signUp mx-auto mt-3 border bg-white p-3'>
                ...
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="d-grid">
                        <Button isLoading={isLoading} type="submit" name="SignUp" />
                        <small>Already registered?<Link href="/login" className='text-primary'>click here to login</Link></small>
                    </div>
                </form>
            </div>
        </>
